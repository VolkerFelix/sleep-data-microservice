...
class TestSleepDataService:
    ...
    def test_storage_integration(self):
        ...
        self.mock_storage.save_sleep_records.assert_called_once_with(self.user_id, sleep_data)
    ...
    def test_calculate_sleep_trends(self):
        ...
        records = [
            {
                ...
                "sleep_quality": 75,
                "sleep_start": f"2023-05-01T23:00:00",
                "sleep_end": f"2023-05-02T06:00:00"
            },
            {
                "date": "2023-05-02",
                "duration_minutes": 430,
                "sleep_quality": 78,
                "sleep_start": f"2023-05-02T23:05:00",
                "sleep_end": f"2023-05-03T06:15:00"
            },
            {
                "date": "2023-05-03",
                "duration_minutes": 440,
                "sleep_quality": 80,
                "sleep_start": f"2023-05-03T23:10:00",
                "sleep_end": f"2023-05-04T06:30:00"
            }
        ]
        ...
        consistency = self.service._calculate_consistency([1380, 1385, 1390])  # Minutes past midnight
        assert consistency < 30  # Fairly consistent times
    
    def test_generate_sleep_recommendations(self):
        """Test generating sleep recommendations based on data."""
        # Test recommendations for short sleep duration
        recommendations = self.service.generate_sleep_recommendations(
            avg_duration=360,  # 6 hours
            avg_quality=75,
            avg_deep=60,
            trends={}
        )
        
        assert any("increase your sleep duration" in rec.lower() for rec in recommendations)
        
        # Test recommendations for low sleep quality
        recommendations = self.service.generate_sleep_recommendations(
            avg_duration=480,  # 8 hours
            avg_quality=55,
            avg_deep=90,
            trends={}
        )
